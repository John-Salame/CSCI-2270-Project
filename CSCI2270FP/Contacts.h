...
private:
 ...
 //// CONSTRUCTOR
Contacts::Contacts() {
	*currentlySortedBy; // initializes root as nullptr
...
//Test
/*
void Contacts::addExample() {
	Contact* contact = new Contact;
	contact->firstName = "Jeff";
	contact->lastName = "Kaplan";
	contact->phoneNumber = "303 303 3003";
	contact->birthdate = "04/20/1899";
	...
	contact->firstTreePointer = firstNode;
	contact->lastTreePointer = lastNode;
	contact->birthTreePointer = birthNode;
...
std::string Contacts::getExample() {
	return firstNameRoot->c->firstName;
}
*/
